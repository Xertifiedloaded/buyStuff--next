...
export default {
  ...
  theme: {
  	extend: {
  		backgroundImage: {
  			'gradient-radial': 'linear-gradient(90.41deg, rgba(255, 255, 255, 0.05) -0.38%, rgba(255, 255, 255, 0) 99.66%)',
  			'gradient-card': 'linear-gradient(116.85deg, rgba(252, 70, 107, 0.2) 0%, rgba(63, 94, 251, 0.2) 100%)',
  			'gradient-button': 'linear-gradient(116.85deg, #FC466B 0%, #3F5EFB 100%)',
