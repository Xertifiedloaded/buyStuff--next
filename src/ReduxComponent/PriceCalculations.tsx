      ...
      <div>
        ...
        <label className="text-sm mt-2 block font-400">
          ...
          <textarea
            ...
            className="p-3 h-[100px] resize-none text-xs border-white placeholder:text-black lg:placeholder:text-gray lg:placeholder:text-xs bg-transparent placeholder:text-sm text-[16px] rounded-md border   w-full outline-none"
          />
        </label>
      </div>
    </>
      ...
      {["name", "email", "phone"].map((field, idx) => (
        <div key={idx} className="flex flex-col mb-3">
          ...
          <input
            ...
            id={field}
            name={field}
            className="p-3 h-[45px] placeholder:text-sm text-[16px] rounded-md border border-white bg-transparent w-full outline-none"
            value={payload[field]}
            onChange={handleChange}
